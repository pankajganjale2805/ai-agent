...
def get_parent_directory(route: Dict, routes: List[Dict]) -> str:
    """
...
def generate_next_pages() -> None:
    ...
    for route in routes:
        ...
        if route["url"].startswith("^"):
            ...
            parent_directory = get_parent_directory(route, routes)
        ...
        try:
            ...
            generate_page_for_route(route, controller_path, template_path)
...
def route_to_component_name(url: str) -> str:
    """
...
def generate_page_for_route(
    ...
    """
    url = route.get("url", "")
    component_name = route_to_component_name(url)
    ...
    prompt = PROMPT_FOR_CODE_CONVERSION(controller_code, template_code, component_name)
    ...
    output_file = output_dir / "page.jsx"
